    ...
    <DataTable :value="items" :paginator="true" :rows="rowsPerPage" :totalRecords="totalRecords" lazy
        ...
        <template #header>
            <div class="flex flex-wrap gap-2 items-center justify-between">
                <h4 class="m-0">Manage Divisi_dept</h4>
                <IconField>
        ...
        <Column field="divisi_kode" header="Divisi_kode" sortable style="min-width: 4rem"></Column>
        <Column field="divisi_name" header="Divisi_name" sortable style="min-width: 4rem"></Column>

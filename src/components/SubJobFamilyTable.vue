<template>
    <DataTable :value="items" :paginator="true" :rows="rowsPerPage" :totalRecords="totalRecords" lazy
        ...
        <Column field="kode" header="Kode Sub JF" sortable style="min-width: 4rem"></Column>
        <Column field="nama" header="Nama Sub JF" sortable style="min-width: 4rem"></Column>
        <Column field="kode_jf" header="Kode JF" sortable style="min-width: 4rem"></Column>
        <Column field="nama_jf" header="Nama JF" sortable style="min-width: 4rem"></Column>

...
<template>
    <DataTable :value="items" :paginator="true" :rows="rowsPerPage" :totalRecords="totalRecords" lazy
        ...
        <template #header>
            <div class="flex flex-wrap gap-2 items-center justify-between">
                ...
                <IconField>
                    ...
                    <Button icon="pi pi-search" outlined rounded class="mr-2 m-2"
                        @click="$emit('search', filters.global.value)" />
                </IconField>
            </div>
        </template>
        ...
        <Column field="kode_jf" header="Kode_jf" sortable style="min-width: 4rem"></Column>
        <Column field="nama_jf" header="Nama_jf" sortable style="min-width: 4rem"></Column>
        <Column field="kode_sjf" header="Kode_sjf" sortable style="min-width: 4rem"></Column>
        <Column field="nama_sjf" header="Nama_sjf" sortable style="min-width: 4rem"></Column>

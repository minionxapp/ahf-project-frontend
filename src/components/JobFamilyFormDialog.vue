        ...
        <form @submit.prevent="handleSubmit">
            <div class="flex flex-col gap-6">
                ...
                <div>
                    ...
                    <InputText rows="5" id="deskripsi" v-model.trim="props.item.deskripsi" required="false" fluid />
                    <small v-if="submitted && !props.item.deskripsi" class="text-red-500">deskripsi is required.</small>
                </div>
...
watch(() => props.item, (newItem) => {
    if (newItem) {
        ...
        dialogHeader.value = newItem.id ? 'Edit Job_family' : 'New Job_family';
    }
}, { immediate: true });

...
<template>
    <DataTable :value="items" :paginator="true" :rows="rowsPerPage" :totalRecords="totalRecords" lazy
        ...
        <Column field="slug" header="Slug" sortable style="min-width: 4rem"></Column>
        <Column field="icon" header="Icon" sortable style="min-width: 4rem"></Column>
        <Column field="route" header="Route" sortable style="min-width: 4rem"></Column>
        ...
        <Column field="parent_menu" header="Parent_menu" sortable style="min-width: 4rem"></Column>
